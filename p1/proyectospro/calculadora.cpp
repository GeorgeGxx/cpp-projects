...
int eleccion,operador1,operador2,resultado;

/*Iniciamos usando un bucle do while para que el programa se ejecute hasta que el usuario seleccione la opcion 5*/ 
do
{
