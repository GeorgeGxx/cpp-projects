...
char nombre[70][35],otro,encontrado;
int clave[70],opc,contar,r,c,contador,x,rencontrado;
float calif[70][7];
...
int main()
{
	do
	{
		...
		printf("4 lista promedio aprobatorio \n");
		...
		switch(opc)
		{
			case 1:
				do
				{
					...
					for(c=1;c<=6;c++)
					{
						calif[contar][0]=calif[contar][0]+calif[contar][c];
					}
