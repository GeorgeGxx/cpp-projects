...
datos pizza[100];
int contar,r,opc,otro,resp,xid,xr,xtipo,xtamano,tamano,i,j;
int auxid,auxtipo,auxtamano;
float auxprecio;
char encontrado;
...
int main()
{
	...
	{
		system("cls");
		printf("MENU PRINCIPAL PIZZERIA UNITEC \n");
		printf("1.- CAPTURA \n");
		printf("2.- LISTA GENERAL \n");
		printf("3.- BUSQUEDA POR ID DE VENTA \n");
		printf("4.- LISTA POR TIPO DE PIZA \n");
		printf("5.- LISTA POR TAMAÑO \n");
		printf("6.- SALIR \n");
		//menu();
		fflush(stdin);
		...
		switch(opc)
		{
			...
			case 3:
				do
				{
					...
					fflush(stdin);
					printf("¿que numero de venta buscas? ");
					scanf("%d",&xid);
					...
					fflush(stdin);
					printf("¿quieres buscar otra venta? ");
					scanf("%c",&otro);
				}while(otro=='2');
				system("pause");
			...
			case 5:
				...
				system("cls");
				printf("Tamaño de pizza a listar \n");
				printf("1 chica \n");
				printf("2 mediana \n");
				printf("3 grande \n");
				printf("4 familiar \n");
				...
				for(r=1;r<=contar;r++)
				{
					if(xtamano==pizza[r].tamano);
					listagral();
				}
				system("pause");
				
			break;
		}//termina switch del menu principal
